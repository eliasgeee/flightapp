#pragma checksum "C:\Users\Elias\source\repos\FlightAppEliasGryp\FlightAppEliasGryp\Views\ShellPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "36D61D6B4E5E6922A2E1CA5B08F19472"
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IShellPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 35 && columnNumber == 151)
                {
                    isobj4VisibilityDisabled = true;
                }
                else if (lineNumber == 36 && columnNumber == 161)
                {
                    isobj5VisibilityDisabled = true;
                }
                else if (lineNumber == 37 && columnNumber == 157)
                {
                    isobj6VisibilityDisabled = true;
                }
                else if (lineNumber == 38 && columnNumber == 194)
                {
                    isobj7VisibilityDisabled = true;
                }
                else if (lineNumber == 39 && columnNumber == 169)
                {
                ...
                else if (lineNumber == 41 && columnNumber == 179)
                {
